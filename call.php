...
.form-control{width:100%; height:35px; margin-bottom:10px; border:solid 1px #ccc;}
.site-button1 {
    background-color: #26c5ef;
    color: #fff;
    padding: 5px 10px;
...
.error_captcha_callback{
  ...
  <form name="ContactFrm"  id="call-pop_form" action="" method="post" enctype="multipart/form-data" onsubmit="return checkValidationcc();">
        ...
        <div class="col-md-12">
          ...
          <textarea  class="form-control" name="umessagecc" id="umessagecc" style="resize:none;position:relative; height:60px;" onkeyup="errMsg1();" placeholder="Message *"></textarea>
        ...
        font-weight:bold; font-family:Modern; font-size:28px; width:100px;" />
          ...
          <input type="submit" style="width:100%;" id="email_number" value="Submit"  name="Enq" class="site-button1">   
          </div>               
        </div>
      </form>
...
<script>
 ...
 $(document).ready(function(){
  ...
  <div class="cp-widget-button" id="myImgcall">
    <div data-brand-color="background"  onclick="show()" class="cp-widget-button__inner"> <img src="<?=$site_url?>/images/call1.png" alt="Call" style="width:25px;"> </div>
  </div>
