...
<style>
	...
	.cap-sty{width:100%; font-size:22px; padding-left:5px; position:relative; height:40px; border-radius:5px; border:solid 1px #f2f2f2;}
...
-->
                  ...
                  <div class="col-md-7 col-xs-7 mpwki">
                    ...
                    <input id="captcha_code" maxlength="4" name="captcha_code" type="text" onkeyup="errCaptcha123();" class="cap-sty">
<br>
...
<li><a href="https://in.pinterest.com/WebKeyIndiaOfficial" target="_blank"><i class="fa fa-pinterest"></i></a></li>
	...
	<li><a href="fa fa-tumblr-square" target="_blank"><i class="fa fa  fa-youtube"></i></a></li>
