...
<div class="slider-wrapper clearfix" style="margin-top:100px;">
  ...
  <div class="responisve-container">
    ...
    <img src="<?=$site_url?>/images/category_banner/<?=$CAT_DATA['category_banner_image_name']?>" class="img-responsive">    
...
<?= str_replace("LOCATION",$location,$CAT_DATA['category_display_name']);?>
...
<?= str_replace("LOCATION",$location,$CAT_DATA['category_description']);?>
</div>
