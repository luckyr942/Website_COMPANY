...
?>
<style>
	.ctmpd{margin-top:80px;}
	@media (min-width:320px) and (max-width:767px) 
	
{.ctmpd{margin-top:05px;}}
...
<h5><a href="<?=$site_url?>" style="color:brown;">Home</a> &raquo; <a href="<?=$site_url?>/services.html" style="color:brown;">Industires</a> &raquo; <a href="<?=$site_url?>/<?=db_scalar("select category_url from tbl_category where 1 and category_id='$productPID'");?>.html" style="color:brown;">
...
<div class="col-md-12" style="margin:0 !important; padding:0 !important; margin:20px 0px !important;">
    
<img src="https://www.eweblink.net/images/online-travel-website-development.jpg" alt="Service Provider of <?=$FINAL_DATA['category_name']?>" title="Service Provider of <?=$FINAL_DATA['category_name']?>" style="width:100%;" /></div>
...
Vestibulum lacinia arcu eget nulla. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Curabitur sodales ligula in libero. Sed dignissim lacinia nunc. Curabitur tortor. Pellentesque nibh. 
...
<a href="javascript:void(0);" onClick="document.getElementById('uname').focus();"><div class="pull-clr16 bdrcorner1"><p class="white-clr pullmian text-center" style="font-size:19px;"><strong > <i class="fa fa-hand-o-right"></i> Click Here to Request a free Quote Now or <i class="fa fa-phone  process-mrleft3"></i>  +91-9958276296</strong></p> </div></a>
    ...
    <h2>What's types of Tour Travels Websites?</h2>
    <ul>
        <li>Static Website</li>
        <li>Dynamic  Website</li>
        <li>Customize  Website</li>
    </ul>
...
<h5 class="white-clr no-margin">RELATED INDUSTRIES</h5>
