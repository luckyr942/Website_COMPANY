      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?=$site_url?>"><img src="<?=$site_url?>/images/logo.png" alt="logo" style="margin-bottom:8px;"></a>
			<img src="<?=$site_url?>/images/google-partner.png" alt="Google Partner" class="dsp-ptnr"> 
		</div>
...
<img src="<?=$site_url?>/images/HTML-Yeti-404-Page.gif" width="100%" style="margin-top:65px;">
