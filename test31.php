...
$w_text="";
 if(isset($_POST['EnqSubmit1'])){
  ...
  @extract($_POST);
       ...
       $short_msg=substr($umessagedd,0,50);
  ...
  function postdata($url,$data)
    ...
    $w_text="  $unamedd %0a $uemaildd %0a $uphonedd %0a $umessagedd";
...
.closechatform:focus {
  ...
  cursor: pointer;
	...
	.form-controld{width:100%; height:40px; margin-bottom:5px; border-radius:5px; padding:8px;}
</style>
...
.error_captcha_res{
      ...
      <div class="wow fadeInDown">
        ...
        <div class="row pullbottom" id="showMSG">
          ...
          <div class="col-md-12">
            ...
            <h3 class="white-clr amihtwo text-center" style="font-size:22px !important; padding:0px; margin-top:10px; position:relative; top:5px;">Need a Consultant</h3>
 ...
 <p id="error_style_res" class="error_message_res"></p>
          ...
          <div class="clearfix"></div>
                <div class="col-md-12">
                  <button type="submit" name="EnqSubmit1" class="btn btn-primary btn-lg" style="margin-top:10px;">Send Message</button>
