...
<title>Best Web Design & Digital Marketing Company in Delhi India</title>
<meta name="description" content="WebKey is the Best Web Design & Digital Marketing Company in Delhi, offers internet marketing services like SEO, SMO, PPC, SMM, SEM & ORM in India.">
<meta name="keywords" content="best website designing company in delhi, website designing company in delhi, web development service in delhi, best web designing company in india, best website designing agency in delhi, best SEO company in delhi, SEO company, best search engine optimization company in delhi, website development in delhi, software development company in delhi, web hosting service in delhi, website redesign services in delhi">
...
<link href="<?=$site_url?>/css/home.css" rel="stylesheet"> 
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-xs-12">
            <?php include("webkey-header-top2.php");?>
          </div>
        </div>
      </div>
      <!--/.container--> 
    </div>
     <?php include("webkey-mega-menu3.php");?>
  </nav>
  <!--/nav--> 
...
<section id="feature" class="no-margin pullpt1">
  <div class="container">
    <div class="  pullmt1">
      <h1 class=" mhead text-center">"Google Partner Company in India"</h1> 
      
      <h4  class="text-center">Best Web Design & Digital Marketing Company in Delhi India</h4>
      ...
      <div class="features">
        <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
          <div class="feature-wrap"> <i class="fa fa-inr"></i>
            <h4>Quality Work in Reasonable Cost</h4>
            <p  >We develop effective quality websites to our clients.</p>
          </div>
        </div>
        <!--/.col-md-4-->
        ...
        <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
          <div class="feature-wrap"> <i class="fa fa-code"></i>
            ...
            <p >Specialized in custom website designs and development</p>
          </div>
        </div>
        <!--/.col-md-4-->
        ...
        <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
          <div class="feature-wrap"> <i class="fa fa-history"></i>
            <h4>Having 15+ Years Experience</h4>
            <p >Have well trained experinced website developers</p>
          </div>
        </div>
        <!--/.col-md-4-->
        ...
        <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
          <div class="feature-wrap"> <i class="fa  fa-cogs"></i>
            <h4>Updated To Latest Technologies</h4>
            <p >We use latest technology to develope the websites</p>
          </div>
        </div>
        <!--/.col-md-4-->
        ...
        <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
          <div class="feature-wrap"> <i class="fa fa-thumbs-o-up "></i>
            <h4>10K Websites/Portals Delivered Successfully</h4>
            <p >Delivered 10k+ websites Successfully on time</p>
          </div>
        </div>
        <!--/.col-md-4-->
        ...
        <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
          <div class="feature-wrap"> <i class="fa fa-support"></i>
            <h4>24*7 Live Client Support</h4>
            <p >Provide dedicated support round the clock for all clients</p>
          </div>
        </div>
        <!--/.col-md-4--> 
      </div>
    ...
    <div class="row">
      <div class="col-sm-6 col-md-4 ">
        <div class="media services-wrap wow fadeInDown pull-clr">
          ...
          <div class="media-body">
            ...
            <p class="white-clr"><a href="<?=$site_url?>/mobile-responsive-web-designs-service.html">Responsive Web Designs</a> <a href="<?=$site_url?>/dynamic-website-designing.html">Dynamic Website</a> <a href="<?=$site_url?>/custom-website-designing-service.html">Custom Website </a> <a href="<?=$site_url?>/website-designing-packages.html">Website Designing Packages </a> <a href="<?=$site_url?>/#">User Friendly Website </a> </p>
          </div>
        </div>
      </div>
       <div class="col-sm-6 col-md-4">
        <div class="media services-wrap wow fadeInDown pull-clr4">
          <div class="" align="center"> <img class="img-responsive" src="<?=$site_url?>/images/services/web-portal-developement.png" alt="Web Development Services in Delhi" title="Web Development Services in Delhi"> </div>
          <div class="media-body">
            <h3 class="media-heading white-clr"><a href="<?=$site_url?>/web-portal-development.html">Web Development Services</a></h3>
      ...
      <div class="col-sm-6 col-md-4">
        <div class="media services-wrap wow fadeInDown pull-clr1">
          <div class="" align="center"> <img class="img-responsive" src="https://webkey.biz/designs4u/demo/dy/webkeyindia/images/services/seo-img.png" alt="Search Engine Optimization in Delhi" title="Search Engine Optimization in Delhi"> </div>
          <div class="media-body">
            <h3 class="media-heading white-clr"><a href="<?=$site_url?>/mobile-application-development.html">Search Engine Optimization</a></h3>
            <p class="white-clr"><a href="<?=$site_url?>/#">Local SEO</a> <a href="<?=$site_url?>/#">Technical SEO</a> <a href="<?=$site_url?>/#">OFF page SEO </a> <a href="<?=$site_url?>/#">ON page SEO </a> <a href="<?=$site_url?>/#">Image SEO </a> </p>
          </div>
        </div>
      </div>
      <div class="col-sm-6 col-md-4">
      ...
      <div class="col-sm-6 col-md-4">
        <div class="media services-wrap wow fadeInDown pull-clr8 ">
          ...
          <div class="media-body">
            <h3 class="media-heading white-clr"><a href="<?=$site_url?>/bulk-sms-solutions.html">PPC Advertisement</a></h3>
            <p class="white-clr"><a href="<?=$site_url?>/promotional-bulk-sms.html">Search Ads</a> <a href="<?=$site_url?>/bulk-sms-software.html">Display Ads</a> <a href="<?=$site_url?>/bulk-sms-packages.html">Social Media Ads </a> <a href="<?=$site_url?>/resale-bulk-sms.html">Shopping Ads </a> <a href="<?=$site_url?>/email-marketing-services.html">Video Ads </a> <a href="<?=$site_url?>/bulk-sms-packages.html">Search Ads </a> <a href="<?=$site_url?>/bulk-sms-packages.html">Remarketing Ads </a></p>
          </div>
      ...
      <div class="col-sm-6 col-md-4">
        <div class="media services-wrap wow fadeInDown pull-clr3">
          ...
          <div class="media-body">
            ...
            <p class="white-clr"><a href="<?=$site_url?>/wordpress-website-development.html">Wordpress Website Development</a> <a href="<?=$site_url?>/durpal-development-service.html">Shopify Development </a> <a href="<?=$site_url?>/magento-development-services.html">Magento development </a>  </p>
          </div>
        </div>
      </div>
...
<h2 class="mhead">Outstanding Reviews</h2>
<div class="clear"></div>
...
<div class="container">
<h2 class="mhead2"> SEO Portfolio </h2>
<div class="clear"></div>
...
<section id="process-bgclr" style="margin:0 !important; padding-top:20px; padding-bottom:20px;" class="no-margin wow fadeInDown">
  <div  style="padding:0 !important;">
    <h2 class="white-clr mhead2">Our process involved in delivering best quality website design services</h2>
  ...
  <?php //include("home-testi.php");?>
  
  <?php //include("gallery4.php");?>
  
<section id="services" class="service-item" style="padding:20px 0;">
  <div class="container">
    <div class="center wow fadeInDown">
      <h2 class="mhead">Having Magnificent Trending in Digital Marketing</h2>
...
<section class="clients-area center wow fadeInDown">
  ...
  <div class="col-md-12 wow fadeInDown ">
    <div class="text-center">
        <h3 class="mhead">Digital Marketing Blogs</h3>
...
<section id="hireservices" class="service-item no-margin pullpt">
  <div class="container">
    <div class=" wow fadeInDown">
      <h2 class="mhead text-center">Hire Dedicated Team / Resource</h2>
    ...
    <div class="row">
      ...
      <div class="col-sm-6 col-md-4">
        <div class="media services-wrap wow fadeInDown myclass" style="background-color:rgba(0,108,108,1);">
          <div class="" align="center"> <img class="img-responsive" src="<?=$site_url?>/images/Hire-Data-Entry-Operator.png" alt="Hire Social Media Handling Team Team in Delhi" title="Hire Social Media Handling Team Team in Delhi"> </div>
          <div class="media-body">
            <h3 class="media-heading white-clr"><a href="<?=$site_url?>/hire-dedicated.html"> Hire Social Media Handling Team</a></h3>
            <p class="white-clr"> Hire a Social Media Handling Team That Excels in Producing effective, high-performing content businesses must overcome various challenges.</p>
          </div>
        </div>
      </div>
    </div>
...
<?php include "home-certificates.php";?>

<?php 
 include("tecnology-we-work.php");
?>
