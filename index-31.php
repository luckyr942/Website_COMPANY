...
<title>Best Website Designing Company in Delhi India</title>
<meta name="description" content="WebKeyIndia is the Best Website Designing Company in Delhi Offering Website Development, Application Development, SEO and Digital Marketing Services in Delhi India.">
<meta name="keywords" content="best website designing company in delhi, development firm in delhi, web development in delhi india, best web design company in delhi india, best website designing firms in delhi india, best web application development in delhi, mobile app development companies in delhi, best search engine optimization companies in delhi India, cms website development in delhi, software development company in delhi India, web hosting service in delhi, website redesign services in delhi India">
...
<meta name="google-site-verification" content="JvR1pjxYy3Yhg4rt1zvumbZdwCHv3nGIBmJyOPz-xqc" />
...
<link rel="stylesheet" type="text/css" href="<?=$site_url?>/portfolio_css/style.css" />s
<style>
...
.modal {
    ...
    height: 2749px!important /* Full height */
...
@media only screen and (max-width: 700px){
	...
	.dsp-ptnr{display:block; width: 100px;
    /***position: relative;
    top: 10px;
    right: 31px;*****/
	position: relative;
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-116984393-7"></script>
<script>
 window.dataLayer = window.dataLayer || [];
 function gtag(){dataLayer.push(arguments);}
 gtag('js', new Date());

 gtag('config', 'UA-116984393-7');
</script>
    ...
    <div class="container-fluid bottom-footer">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?=$site_url?>" style="padding-top:17px;"><img src="<?=$site_url?>/images/logo.png" class="img-responsive" alt="Best web designing company in delhi" title="Best web designing company in delhi"></a><img src="images/google-partner.png" class="dsp-ptnr"> 
		 <!--------<img src="images/google-partner.png" style="width:100px; position:relative; top:14px;" class="hidden-xs">-------->
		  </div>
...
<div class="slider-wrapper clearfix hidden-xs" style="margin-top:70px;">
...
<section class="no-margin pullpt1 hidden-lg hidden-md hidden-sm visible-xs" style="margin-top:44px;">
  <div class="container-fluid">
    <div class="row">
      <div class="col-xs-12">
      <img src="images/web-banner.jpg" class="img-responsive" style="width:100%;">
      </div>
      <!--/.services--> 
    </div>
    <!--/.row--> 
...
<section style="padding:0px;">
		    <div class="container">
				   <div class="row">
					    <div class="col-md-12">
							<img src="images/1.jpg" style="width:100%" class="hidden-xs hidden-sm">
								<img src="images/2.jpg" style="width:100%; padding:10px 0px;" class="hidden-lg hidden-md">
					   </div>
				</div>
		   </div>
	   </section>
...
<section id="feature" class="no-margin pullpt1">
  <div class="container">
    <div class="center  pullmt1 ">
      <h2>"WebKeyIndia"</h2> <h1 class="amiBlck">Best Website Designing Company in India</h1>
      <hr>
      ...
      <div class="features">
        ...
        <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
          <div class="feature-wrap"> <i class="fa fa-history"></i>
            <h2>Having 10+ Years Experience</h2>
...
<center><img src="images/seo-icons/mangaldoshshantiujjain.png" class="responsive-img" alt="SEO Portfolio" style="height:55px"/></center>
</div>
<div class="clear"></div>
...
<div class="seoport">
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
<center><img src="images/seo-icons/haridwartirithpurohit.png" class="responsive-img" alt="SEO Portfolio" style="height:55px"/></center>
</div>
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pleft pright">
<table width="100%" border="1" align="left" style="border:1px solid #d0d0d0; border-collapse:collapse;">
<tr>
...
<div class="seoport">
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
<center><img src="images/seo-icons/sankatmochanambulance.png" class="responsive-img" alt="SEO Portfolio" style="height:55px"/></center>
</div>
<div class="clear"></div>
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pleft pright">
<table width="100%" border="1" align="left" style="border:1px solid #d0d0d0; border-collapse:collapse;">
...
<div class="seoport">
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
<center><img src="images/seo-icons/naveenambulance.png" class="responsive-img" alt="SEO Portfolio" style="height:55px"/></center>
</div>
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pleft pright">
<table width="100%" border="1" align="left" style="border:1px solid #d0d0d0; border-collapse:collapse;">
<tr>
...
<div class="seoport">
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
<center><img src="images/seo-icons/garima-crane-service.png" class="responsive-img" alt="SEO Portfolio" style="height:55px"/></center>
</div>
<div class="clear"></div>
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pleft pright">
<table width="100%" border="1" align="left" style="border:1px solid #d0d0d0; border-collapse:collapse;">
...
<div class="seoport">
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
<center><img src="images/seo-icons/billu-crane.png" class="responsive-img" alt="SEO Portfolio" style="height:55px"/></center>
</div>
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pleft pright">
<table width="100%" border="1" align="left" style="border:1px solid #d0d0d0; border-collapse:collapse;">
<tr>
...
<div class="seoport">
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
<center><img src="images/seo-icons/nicecoolingcare.png" class="responsive-img" alt="SEO Portfolio" style="height:55px"/></center>
</div>
<div class="clear"></div>
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pleft pright">
<table width="100%" border="1" align="left" style="border:1px solid #d0d0d0; border-collapse:collapse;">
...
<div class="seoport">
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
<center><img src="images/seo-icons/ssrefrigeration.png" class="responsive-img" alt="SEO Portfolio" style="height:55px"/></center>
</div>
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pleft pright">
<table width="100%" border="1" align="left" style="border:1px solid #d0d0d0; border-collapse:collapse;">
<tr>
...
<div class="seoport">
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
<center><img src="images/seo-icons/shivangi-enterprises.png" class="responsive-img" alt="SEO Portfolio" style="height:55px"/></center>
</div>
<div class="clear"></div>
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pleft pright">
<table width="100%" border="1" align="left" style="border:1px solid #d0d0d0; border-collapse:collapse;">
...
<div class="seoport">
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
<center><img src="images/seo-icons/starelevators.png" class="responsive-img" alt="SEO Portfolio" style="height:55px"/></center>
</div>
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pleft pright">
<table width="100%" border="1" align="left" style="border:1px solid #d0d0d0; border-collapse:collapse;">
<tr>
...
<div class="seoport">
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
<center><img src="images/seo-icons/brmarketingindia.png" class="responsive-img" alt="SEO Portfolio" style="height:55px"/></center>
</div>
<div class="clear"></div>
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pleft pright">
<table width="100%" border="1" align="left" style="border:1px solid #d0d0d0; border-collapse:collapse;">
...
<div class="seoport">
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
<center><img src="images/seo-icons/semi.png" class="responsive-img" alt="SEO Portfolio" style="height:55px"/></center>
</div>
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pleft pright">
<table width="100%" border="1" align="left" style="border:1px solid #d0d0d0; border-collapse:collapse;">
<tr>
...
<div class="seoport">
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
<center><img src="images/seo-icons/oraclepestcontrol.png" class="responsive-img" alt="SEO Portfolio" style="height:55px"/></center>
</div>
<div class="clear"></div>
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pleft pright">
<table width="100%" border="1" align="left" style="border:1px solid #d0d0d0; border-collapse:collapse;">
...
<div class="seoport">
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
<center><img src="images/seo-icons/termokil.png" class="responsive-img" alt="SEO Portfolio" style="height:55px"/></center>
</div>
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pleft pright">
<table width="100%" border="1" align="left" style="border:1px solid #d0d0d0; border-collapse:collapse;">
<tr>
...
<div class="seoport">
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
<center><img src="images/seo-icons/indiatourismincredible.png" class="responsive-img" alt="SEO Portfolio" style="height:55px"/></center>
</div>
<div class="clear"></div>
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pleft pright">
<table width="100%" border="1" align="left" style="border:1px solid #d0d0d0; border-collapse:collapse;">
...
<div class="seoport">
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
<center><img src="images/seo-icons/raftingpackagesinrishikesh.png" class="responsive-img" alt="SEO Portfolio" style="height:55px"/></center>
</div>
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pleft pright">
<table width="100%" border="1" align="left" style="border:1px solid #d0d0d0; border-collapse:collapse;">
<tr>
...
<h1 style="font-size:40px !important; color:#000;"><strong>Outstanding Reviews</strong></h1>
<div class="clear"></div>

                <div class="col-md-4"><a href="#">
                                    <img src="images/googlerating-1.png" alt="">
                                </a></div>
                        <div class="col-md-4"><a href="#">
                                    <img src="images/justdialrating-3.png" alt="">
                                </a></div>    
                                <div class="col-md-4"><a href="#">
                                    <img src="images/facebookrating-2.png" alt="">
                                </a></div>    
                    </div>
</section>
...
<section id="process-bgclr" style="margin:0 !important; padding-top:40px; padding-bottom:20px;" class="no-margin wow fadeInDown">
  ...
  <div class="container">
    <div class="wow fadeInDown">
      <div class="row">
        <div class="col-md-2 col-sm-4 col-xs-4 process-mrleft ">
          <h3  class=" white-clr process-mrleft1">Planing</h3>
...
<section id="services" class="service-item" style="padding:35px 0;">
  <div class="container">
    <div class="center wow fadeInDown">
      <h2>Having magnificent command in trending web technologies</h2>
      <p class="lead">We as a professional website designing and development company based in India expert in all type of Mobile Responsive Websites Desinging Services, Website Redesigning Services, Website Maintinence Services and Online Shopping Cart Solution services including Payment Gateway Integration services.</p>
    </div>
    <div class="row">
      <div class="col-sm-6 col-md-4 ">
        <div class="media services-wrap wow fadeInDown pull-clr9">
          <div class="" align="center"> <img class="img-responsive" src="<?=$site_url?>/images/services/redesign-servies.png" alt="Website Redesigning Services in Delhi" title="Website Redesigning Services in Delhi"> </div>
          <div class="media-body">
            <h3 class="media-heading white-clr"><a href="<?=$site_url?>/web-re-designing-service.html">Website Redesigning Services</a></h3>
            <p class="white-clr">If you are looking some attrative and creative changes in your website, then we have experties in redesigning of the websites</p>
          </div>
        </div>
      </div>
      <div class="col-sm-6 col-md-4">
        <div class="media services-wrap wow fadeInDown pull-clr10">
          <div class="" align="center"> <img class="img-responsive" src="<?=$site_url?>/images/services/responsive-design.png" alt="Mobile Responsive Web Design in Delhi" title="Mobile Responsive Web Design in Delhi"> </div>
          <div class="media-body">
            <h3 class="media-heading white-clr"><a href="<?=$site_url?>/mobile-responsive-web-designs-service.html">Mobile Responsive Web Design</a></h3>
            <p class="white-clr">In today's small devices trends it's mandatory for your business that you must have mobile responsive website</p>
          </div>
        </div>
      </div>
      <div class="col-sm-6 col-md-4">
        <div class="media services-wrap wow fadeInDown pull-clr11">
          <div class="" align="center"> <img class="img-responsive" src="<?=$site_url?>/images/services/payment-gatway.png" alt="Shopping Cart Solution in Delhi" title="Shopping Cart Solution in Delhi"> </div>
          <div class="media-body">
            <h3 class="media-heading white-clr"><a href="<?=$site_url?>/ecommerce-web-development.html">Shopping Cart Solution</a></h3>
            <p class="white-clr">Our team is expert in making your website as your eShop with help of our Payment Gateway Integration Services.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-sm-6 col-md-4 ">
        <div class="media services-wrap wow fadeInDown myclass" style="background-color:rgba(0,82,164,1);">
          <div class="" align="center"> <img class="img-responsive" src="<?=$site_url?>/images/Hire-Website-Developer.png" alt="Hire Website Developer in Delhi" title="Hire Website Developer in Delhi"> </div>
          <div class="media-body">
            <h3 class="media-heading white-clr"><a href="<?=$site_url?>/hire-dedicated.html">Hire Website Developer</a></h3>
      ...
      <div class="col-sm-6 col-md-4">
        <div class="media services-wrap wow fadeInDown myclass" style="background-color:rgba(60,60,60,1);">
          <div class="" align="center"> <img class="img-responsive" src="<?=$site_url?>/images/Hire-Digital Marketing-Expert.png" alt="Hire Digital Marketing Expert in Delhi" title="Hire Digital Marketing Expert in Delhi"> </div>
          <div class="media-body">
            <h3 class="media-heading white-clr"><a href="<?=$site_url?>/hire-dedicated.html">Hire Digital Marketing Expert</a></h3>
      ...
      <div class="col-sm-6 col-md-4">
        <div class="media services-wrap wow fadeInDown myclass" style="background-color:rgba(0,108,108,1);">
          <div class="" align="center"> <img class="img-responsive" src="<?=$site_url?>/images/Hire-Data-Entry-Operator.png" alt="Hire Data Entry Operator in Delhi" title="Hire Data Entry Operator in Delhi"> </div>
          <div class="media-body">
            <h3 class="media-heading white-clr"><a href="<?=$site_url?>/hire-dedicated.html"> Hire Data Entry Operator</a></h3>
            <p class="white-clr">Online Data Searches, Data Entry from Directories (Online / Offline), ECommerce Product Entry, Online Coping and Pasting</p>
          </div>
        </div>
      </div>
    </div>
...
<?php include("webkey-footer31.php");?>
		</div>	