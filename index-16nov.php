    ...
    <div class="container-fluid bottom-footer">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?=$site_url?>" style="padding-top:17px;"><img src="<?=$site_url?>/images/logo.png" class="img-responsive" alt="Best web designing company in delhi" title="Best web designing company in delhi"></a>
...
<section class="no-margin pullpt1 hidden-lg hidden-md hidden-sm visible-xs" style="margin-top:44px;">
  <div class="container-fluid">
    <div class="row">
      <div class="col-xs-12" style="position:relative; top:23px;">
				   ...
				   <div class="row">
					    <div class="col-md-12">
							<img src="images/1.jpg" style="width:100%" class="hidden-xs hidden-sm">
								<img src="images/2.jpg" style="width:100%; padding:35px 0px; 10px 0px" class="hidden-lg hidden-md">
					   </div>
				</div>
		   </div>
	   </section>
